      ...
      <header className="sticky top-0 z-20 h-14 bg-surface-container-lowest/80 backdrop-blur-md border-b border-outline-variant flex items-center justify-between px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="ml-2 px-4 py-2 bg-gradient-to-r from-primary to-primary-container text-white text-sm font-label font-semibold rounded-xl hover:opacity-90 transition flex items-center gap-1.5"
          >
